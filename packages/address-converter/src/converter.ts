import {
  ...
  export const PlugChain = bech32Chain('PLUGCHAIN', 'gx')
  
  export const ethToGx = (ethAddress: string) => {
    const data = ETH.decoder(ethAddress)
    return PlugChain.encoder(data)
  }
  
  export const gxToEth = (evmosAddress: string) => {
    const data = PlugChain.decoder(evmosAddress)
